...
<html lang="en">
  ...
  <body>
    ...
    <section id="slide-home" class="container no-column">
    ...
    <section id="bajada-blog" class="container no-column">
    	...
    	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-column texto">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna” ”aliqua. Ut enim ad minim veniam, quis</p>
        </div>
    </section>
            ...
            <div class="item">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <a href="single.php" class="fcenter mas">Seguir leyendo</a>                 
                    </div>
                </div>
            </div>
