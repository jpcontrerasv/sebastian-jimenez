    ...
    <section id="breadcrumbs">
    	<div class="container no-column">
            <div class="col-lg-12 text-left no-column">
                <ol class="breadcrumb">
                  <li><a href="mascotas-perdidas-tema.php">Inicio</a></li>
	...
	<section id="header-secciones" class="box fwidth text-center">
    	<div class="container no-column">
        	<div class="col-lg-12 text-center no-column">
		    	<img src="img/header-perdidas.jpg" alt="">
        	</div>
        </div>
    </section>
    ...
    <section id="blog-home" class="container no-column">
    	...
    	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        	...
        	<div id="tabs-falsas" class="box fwidth fleft">
            	<a href="mascotas-perdidas.php" class="active">Mascotas perdidas</a>
                <a href="mascotas-encontradas.php">Mascotas Encontradas</a>                
            </div>
        	...
        	<div id="filtro-perdidas" class="box fwidth fleft">
                ...
                <ul>
                    <li><a href="mascotas-perdidas-tema.php">Santiago (22)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Concepción (16)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Valparaíso (15)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Iquique (12)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">La Serena (8)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Talca (7)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Temuco (7)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Ovalle (6)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Puerto Montt (5)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Chiloé (2)</a></li>
                    <li><a href="mascotas-perdidas-tema.php">Punta Arenas (2)</a></li>
                </ul>
    			...
    			<div class="container-fluid">
    		    	<div class="col-lg-12 text-center">
    		            <ul class="pagination pagination-lg">
    		                <li><a href="mascotas-perdidas-tema.php">&laquo;</a></li>
    		                <li><a href="mascotas-perdidas-tema.php">1</a></li>
    		                <li><a href="mascotas-perdidas-tema.php">2</a></li>
    		                <li><a href="mascotas-perdidas-tema.php">3</a></li>
    		                <li><a href="mascotas-perdidas-tema.php">&raquo;</a></li>
    		            </ul>
    		        </div>
    		    </div>
    		</section>
