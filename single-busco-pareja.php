    	...
    	<div class="container no-column">
            <div class="col-lg-12 text-left no-column">
                <ol class="breadcrumb">
                  ...
                  <li class="active">Single pareja</li>
                </ol>
            </div>
        </div>
    </section>
	<section id="header-secciones" class="box fwidth text-center">
    	<div class="container no-column">
        	<div class="col-lg-12 text-center no-column">
		    	<a href="busco-pareja.php"><img src="img/header-pareja.jpg" alt=""></a>
        	</div>
        </div>
    </section>
    	...
    	<div class="container no-column">
    		...
    		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
    			<div class="container-fluid">
    				...
    				<div class="pregunta single-pareja box fwidth fleft">
                    	<div class="box fcenter fwidth fleft retrato-pareja text-center">
                        	<img src="img/kurt.jpg" alt="">
                        </div>
    					<h3>Kurt</h3>
    				
    					<p>Kurt es un gato persa de 4 años que aún no ha dejado descendencia en este mundo.</p>
                        <p>por <strong>Carolina Burgos</strong></p>
                        <p><strong>Contactar a: correo@mail.com</strong></p>
    				</div>
